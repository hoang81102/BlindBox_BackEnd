...
namespace Services
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(ITokenService tokenService, ICurrentUserService currentUserService, UserManager<ApplicationUser> userManager, IMapper mapper, ILogger<AccountService> logger)
        {
